          ...
          <section className="page-enter mx-auto max-w-3xl">
            ...
            {step === 1 ? (
              <div className="overflow-hidden rounded-3xl border border-blue-100 bg-white shadow-xl shadow-blue-100/60" data-step-fields>
                ...
                <div className="mt-6"><div className="mb-3 flex items-center justify-between"><p className="text-sm font-extrabold text-slate-900">கூடுதல் விவரங்கள்</p><span className="rounded-full bg-slate-100 px-2.5 py-1 text-[11px] font-bold text-slate-500">விருப்பமானது</span></div><div className="grid gap-3 rounded-2xl border border-slate-200 bg-slate-50 p-4 sm:grid-cols-3">{moneyInput("funeralCosts", "அவசியச் செலவு")}{moneyInput("debts", "மொத்தக் கடன்")}{moneyInput("bequest", "வஸிய்யத்")}</div></div>
